package br.com.anderson.rest_spring_java.unitetests.mapper;
...
import br.com.anderson.rest_spring_java.unitetests.mocks.MockPerson;
...
public class ObjectMapperTests {
    ...
    public <O, D> List<D> parseListObject(List<O> origin, Class<D> destination) {
        return origin.stream().map(o -> parseObject(o, destination)).collect(java.util.stream.Collectors.toList());
    }
